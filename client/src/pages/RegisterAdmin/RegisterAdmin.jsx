...
export default function RegisterAdmin() {
  ...
  const validate = () => {
    ...
    if (!checkTokenExists(tokens, formData.adminToken)) {
      errors.adminToken = "Invalid admin token";
    }
    return errors;
  };
  ...
  const handleSubmit = async (e) => {
    ...
    const user = new User();
    const newUser = user.createAdmin(formData);
      ...
      >
        ...
        {!isRegistered && (
          ...
          >
            ...
            />
            {errors.adminToken && (
              <Alert severity="error">{errors.adminToken}</Alert>
            )}
            <TextField
              margin="normal"
              required
